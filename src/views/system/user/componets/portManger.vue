  ...
  <div class="container">
    ...
    >
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="层号">
          <el-select v-model="form.tierNumber" placeholder="请选择车位层号" size="small" style="width:420px">
            <el-option
              v-for="item in options.tierNumber"
              :key="item.dictValue"
              :label="item.dictLabel"
        ...
        <el-form-item label="区域号">
          <el-select v-model="form.areaNumber" placeholder="请选择车位区域号" size="small" style="width:400px">
            <el-option
              v-for="item in options.areaNumber"
              :key="item.dictValue"
              :label="item.dictLabel"
