  ...
  <div class="app-container">
    ...
    <el-row>
      <el-col :span="18" :offset="6">
        <!-- 查询条件开始 -->
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="54px">
          ...
          <el-form-item label="订单号" prop="isLeave">
            <el-input
              v-model="queryParams.carNumber"
              placeholder="请输入订单号"
              clearable
          ...
          <el-form-item label="订单状态" prop="isPayed" label-width="68px">
          ...
          <el-form-item label="支付时间" label-width="68px">
            <el-date-picker
    ...
    <el-table v-loading="loading" border :data="carTableList" stripe>
      <el-table-column label="订单号" align="center" prop="carNumber" />
      <el-table-column label="车牌号" align="center" prop="carNumber" />
      <el-table-column label="停车时长" align="center" prop="carPhone" />
      <el-table-column label="支付类目" align="center" prop="depotCategory" />
      <el-table-column label="支付时间" align="center" prop="carCategory" />
      <el-table-column label="订单金额" align="center" prop="carStatus" :formatter="carStatusFormate" />
      <el-table-column label="优惠金额" align="center" prop="timeSection" />
      <el-table-column label="实付金额" align="center" prop="carAddress" />
      <el-table-column label="支付平台" align="center" prop="remark" />
